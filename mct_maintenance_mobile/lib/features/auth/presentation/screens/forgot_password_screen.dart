...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Future<void> _resetPassword() async {
    ...
    try {
      ...
      await authRepository.requestResetCode(contact);
      ...
      if (mounted) {
        ...
        SnackBarHelper.showSuccess(
          context,
          _isPhone
              ? 'Code envoyé par SMS au $contact'
              : 'Code envoyé à $contact',
          emoji: _isPhone ? '📱' : '✉️',
          duration: const Duration(seconds: 4),
        );

        // Navigation directe et immédiate vers l'écran de saisie du code OTP et du nouveau mot de passe
                                      ...
                                      children: [
                                        ...
                                        TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintText:
                                                'email@exemple.com ou 0700000000',
