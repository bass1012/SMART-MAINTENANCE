...
class _EmailVerificationScreenState extends State<EmailVerificationScreen> {
  ...
  Future<void> _updateLocalUserStatus(AuthRepository authRepository) async {
    try {
  ...
  Future<void> _verifyCode() async {
    ...
    try {
      ...
      final response = await authRepository.verifyEmailCode(widget.email, code);
  ...
  Future<void> _resendCode({String method = 'sms'}) async {
    ...
    try {
      final authRepository = context.read<AuthRepository>();
      final response = await authRepository.resendVerificationCode(
        widget.email,
