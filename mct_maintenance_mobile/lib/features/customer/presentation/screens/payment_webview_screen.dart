...
class _PaymentWebViewScreenState extends State<PaymentWebViewScreen> {
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onPageStarted: (String url) {
            ...
            if (kDebugMode) if (kDebugMode) debugPrint('🌐 WebView page started: $url');
          },
          onPageFinished: (String url) {
            setState(() {
              _isLoading = false;
            });
            if (kDebugMode) if (kDebugMode) debugPrint('✅ WebView page finished: $url');
            _checkForPaymentCompletion(url);
          },
          onNavigationRequest: (NavigationRequest request) {
            if (kDebugMode) if (kDebugMode) debugPrint('🔗 Navigation request: ${request.url}');
          ...
          onWebResourceError: (WebResourceError error) {
            if (kDebugMode) if (kDebugMode) debugPrint('❌ WebView error: ${error.description}');
          },
        ),
      )
  ...
  void _handlePaymentSuccess() {
    ...
    if (kDebugMode) if (kDebugMode) debugPrint('✅ Paiement détecté comme réussi');
  ...
  void _handlePaymentFailure() {
    ...
    if (kDebugMode) if (kDebugMode) debugPrint('❌ Paiement détecté comme échoué');
