...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  void initState() {
    super.initState();
    _notificationRepository = context.read<CustomerNotificationRepository>();
    _loadNotifications();
  }
  ...
  void _handleNotificationTap(Map<String, dynamic> notification) {
    ...
    if (kDebugMode) debugPrint('   Données finales pour navigation: $notificationData');
      ...
      child: Dismissible(
        ...
        color: isRead
            ...
            : const Color(0xFF0a543d)
                .withValues(alpha: 0.45), // Vert AppBar moins transparent
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: isRead
              ? Colors.grey.shade200
              : const Color(0xFF0a543d).withValues(
                  alpha: 0.70), // Vert AppBar plus marqué et moins transparent
          width: 1.2,
        ),
        boxShadow: [
          BoxShadow(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: _getNotificationColors(type)[0].withValues(alpha: 0.3),
                      blurRadius: 8,
