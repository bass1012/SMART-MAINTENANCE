...
class _ComplaintsScreenState extends State<ComplaintsScreen> {
  ...
  Future<void> _loadComplaints() async {
    try {
      final complaintRepository = context.read<ComplaintRepository>();
      final complaints = await complaintRepository.getCustomerComplaints();
      if (mounted) {
        setState(() {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButtonFormField<String>(
                      initialValue: selectedRelatedTo,
                      isExpanded: true,
                      style: GoogleFonts.poppins(
  ...
  Future<void> _createComplaint(
    ...
    try {
      ...
      final complaintRepository = context.read<ComplaintRepository>();
      await complaintRepository.createComplaint(complaint.toJson());
