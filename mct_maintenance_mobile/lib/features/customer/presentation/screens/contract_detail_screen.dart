...
class _ContractDetailScreenState extends State<ContractDetailScreen> {
  ...
  Future<void> _refreshContract() async {
    ...
    try {
      final updatedContract = await _contractRepository.getContractDetails(_contract.id.toString());
  ...
  Future<void> _requestRenewal() async {
    ...
    try {
      final response =
          await _contractRepository.requestContractRenewal(widget.contract.id);
