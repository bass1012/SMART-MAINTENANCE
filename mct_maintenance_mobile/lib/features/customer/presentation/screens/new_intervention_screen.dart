...
class _NewInterventionScreenState extends State<NewInterventionScreen> {
  ...
  String _maintenancePaymentOption = 'split'; // 'split' (50%) ou 'full' (100%)
  ...
  Future<void> _loadDiagnosticFee() async {
    try {
      ...
      final response = await interventionRepository.getDiagnosticConfig();
  ...
  Future<void> _loadRepairServices() async {
    ...
    try {
      final serviceRepository = context.read<ServiceRepository>();
      final services = await serviceRepository.getActiveRepairServices();
      setState(() {
  ...
  Future<void> _loadInstallationServices() async {
    ...
    try {
      final serviceRepository = context.read<ServiceRepository>();
      final services = await serviceRepository.getActiveInstallationServices();
      setState(() {
  ...
  Future<void> _submitIntervention() async {
    ...
    try {
      ...
      if (kDebugMode) debugPrint('🔍 [NewIntervention] UserData keys: ${userData?.keys.toList()}');
      if (kDebugMode) debugPrint('🔍 [NewIntervention] CustomerId extrait: $customerId');
      ...
      // Ajouter l'offre de maintenance et l'option de paiement
      if (_selectedType == 'Maintenance' && _selectedMaintenanceOffer != null) {
        ...
        interventionData['payment_option'] = _maintenancePaymentOption;
      }
                  ...
                  Container(
                    ...
                    child: _isLoadingOffers
                        ...
                        : DropdownButtonFormField<String>(
                            initialValue: _selectedMaintenanceOffer,
                            isExpanded: true,
                            decoration: InputDecoration(
                  ...
                  Container(
                    ...
                    child: _isLoadingInstallationServices
                        ...
                        : DropdownButtonFormField<int>(
                            initialValue: _selectedInstallationServiceId,
                            isExpanded: true,
                            decoration: InputDecoration(
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(12),
                ...
                if (_selectedType == 'repair') ...[
                  ...
                  Container(
                    ...
                    child: _isLoadingRepairServices
                        ...
                        : DropdownButtonFormField<int>(
                            initialValue: _selectedRepairServiceId,
                            isExpanded: true,
                            decoration: InputDecoration(
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(12),
