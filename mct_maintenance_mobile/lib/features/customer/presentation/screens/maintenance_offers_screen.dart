...
class _MaintenanceOffersScreenState extends State<MaintenanceOffersScreen>
  ...
  Future<void> _loadSubscriptions() async {
    ...
    try {
      ...
      if (kDebugMode) debugPrint('✅ Souscriptions reçues: ${subscriptions.length}');
      ...
      if (kDebugMode) debugPrint('❌ Erreur lors du chargement des souscriptions: $e');
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                          ...
                          final result = await Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => ContractPaymentScreen(
                                subscriptionId: id,
                                reference: subscription['reference'] ?? 'CTR-$id',
                                amount: price.toDouble(),
                                contractType: 'scheduled',
                                equipment: subscription['equipment_description'] ?? 'Équipement',
            ...
            if (status == 'active' && (paymentStatus == 'paid' || paymentStatus == 'partial'))
              Padding(
                padding: const EdgeInsets.only(top: 12),
                child: SizedBox(
                  width: double.infinity,
