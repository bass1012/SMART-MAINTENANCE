...
class _TechnicianCalendarScreenState extends State<TechnicianCalendarScreen> {
  ...
  Future<void> _loadEvents() async {
    ...
    try {
      ...
      final response = await _interventionRepository.getTechnicianCalendar(
        ...
        setState(() {
          ...
          for (var appointment in appointments) {
            ...
            if (dateStr != null) {
              ...
              if (kDebugMode) debugPrint('🔑 [CALENDAR] Clé de date: $dateKey');
              ...
              if (kDebugMode) debugPrint('✅ [CALENDAR] Événement ajouté à la date $dateKey');
            }
          }
          ...
          if (kDebugMode) debugPrint('📍 [CALENDAR] Jour sélectionné: $_selectedDay');
          print(
                ...
                .map((event) => Container(
                      ...
                      child: ListTile(
                        ...
                        trailing: Container(
                          ...
                          child: Text(
                            event['time']?.toString().replaceAll(':', 'h') ?? '',
                            style: GoogleFonts.poppins(
                              color: Colors.white,
                              fontWeight: FontWeight.bold,
                              fontSize: 13,
