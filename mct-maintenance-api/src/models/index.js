...
CustomerProfile.belongsTo(CustomerProfile, { foreignKey: 'referred_by_id', as: 'referrer' });
CustomerProfile.hasMany(CustomerProfile, { foreignKey: 'referred_by_id', as: 'referredCustomers' });
// ...existing code...
